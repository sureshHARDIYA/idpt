...
import VideoFormModal from 'view/video/form/VideoFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/video/videoSelectors';

class VideoAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
  ...
  fetchFn = (value, limit) => {
    return VideoService.listAutocomplete(value, limit);
  };
...
export default connect(select)(VideoAutocompleteFormItem);
