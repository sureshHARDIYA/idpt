...
import selectors from 'modules/scoredData/scoredDataSelectors';

class ScoredDataListItem extends Component {
  valueAsArray = () => {
...
export default connect(select)(ScoredDataListItem);
