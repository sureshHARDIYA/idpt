...
import BioAnalyzedFormModal from 'view/bioAnalyzed/form/BioAnalyzedFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/bioAnalyzed/bioAnalyzedSelectors';

class BioAnalyzedAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
  ...
  fetchFn = (value, limit) => {
    return BioAnalyzedService.listAutocomplete(value, limit);
  };
...
export default connect(select)(BioAnalyzedAutocompleteFormItem);
