    ...
    return (
      <Toolbar>
        ...
        {this.props.hasPermissionToAuditLogs && (
          <Link to="/audit-logs?entityNames=taxonomy">
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: taxonomySelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: taxonomySelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(TaxonomyToolbar);
