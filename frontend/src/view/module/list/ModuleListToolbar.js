...
class ModuleToolbar extends Component {
  doExport = () => {
    ...
    return (
      <Toolbar>
        ...
        {this.props.hasPermissionToAuditLogs && (
          <Link to="/audit-logs?entityNames=module">
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: moduleSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: moduleSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(ModuleToolbar);
