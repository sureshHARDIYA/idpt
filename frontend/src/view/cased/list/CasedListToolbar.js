    ...
    return (
      <Toolbar>
        ...
        {this.props.hasPermissionToAuditLogs && (
          <Link to="/audit-logs?entityNames=cased">
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: casedSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: casedSelectors.selectPermissionToImport(
      state,
    ),
  };
}
