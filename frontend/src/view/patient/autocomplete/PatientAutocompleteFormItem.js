...
import PatientFormModal from 'view/patient/form/PatientFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/patient/patientSelectors';

class PatientAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
...
export default connect(select)(PatientAutocompleteFormItem);
