...
import DocumentFormModal from 'view/document/form/DocumentFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/document/documentSelectors';

class DocumentAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
...
export default connect(select)(DocumentAutocompleteFormItem);
