...
function select(state) {
  return {
    ...
    hasPermissionToCreate: recordSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: recordSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(RecordToolbar);
