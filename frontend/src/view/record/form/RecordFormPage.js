...
import actions from 'modules/record/form/recordFormActions';
import selectors from 'modules/record/form/recordFormSelectors';
...
export default connect(select)(RecordFormPage);
