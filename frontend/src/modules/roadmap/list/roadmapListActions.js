...
import selectors from 'modules/roadmap/list/roadmapListSelectors';
import { i18n } from 'i18n';
import exporterFields from 'modules/roadmap/list/roadmapListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'ROADMAP_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      new Exporter(
        exporterFields,
        i18n('entities.roadmap.exporterFileName'),
