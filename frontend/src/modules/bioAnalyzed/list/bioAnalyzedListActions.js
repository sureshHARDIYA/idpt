...
import exporterFields from 'modules/bioAnalyzed/list/bioAnalyzedListExporterFields';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await BioAnalyzedService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.bioAnalyzed.exporterFileName'),
