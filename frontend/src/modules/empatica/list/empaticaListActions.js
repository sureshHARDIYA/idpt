...
import exporterFields from 'modules/empatica/list/empaticaListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'EMPATICA_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await EmpaticaService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.empatica.exporterFileName'),
