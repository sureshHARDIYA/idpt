...
import exporterFields from 'modules/taxonomy/list/taxonomyListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'TAXONOMY_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await TaxonomyService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.taxonomy.exporterFileName'),
