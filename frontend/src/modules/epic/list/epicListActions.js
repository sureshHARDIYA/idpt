import AudioService from 'modules/epic/epicService';
import selectors from 'modules/epic/list/epicListSelectors';
import { i18n } from 'i18n';
import exporterFields from 'modules/epic/list/epicListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'EPIC_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await AudioService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.epic.exporterFileName'),
