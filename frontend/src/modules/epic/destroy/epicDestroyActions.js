import listActions from 'modules/audio/list/audioListActions';
...
const actions = {
  ...
  doDestroy: (id) => async (dispatch) => {
    try {
      ...
      Message.success(i18n('entities.audio.destroy.success'));
  ...
  doDestroyAll: (ids) => async (dispatch) => {
    try {
      ...
      Message.success(
        i18n('entities.audio.destroyAll.success'),
      );
