...
import exporterFields from 'modules/cased/list/casedListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'CASED_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await CasedService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.cased.exporterFileName'),
