...
/**
 * Handles BioAnalyzed operations
 */
module.exports = class BioAnalyzedService {
  constructor({ currentUser, language }) {
    this.repository = new BioAnalyzedRepository();
  ...
  /**
   * Destroy all BioAnalyzeds with those ids.
   *
   * @param {*} ids
   */
  ...
  /**
   * Finds BioAnalyzeds for Autocomplete.
   *
   * @param {*} search
   * @param {*} limit
   */
  ...
  /**
   * Finds BioAnalyzeds based on the query.
   *
   * @param {*} args
   */
  ...
  /**
   * Imports a list of BioAnalyzeds.
   *
   * @param {*} data
   * @param {*} importHash
   */
