const AssignmentResponseRepository = require(
  '../database/repositories/assignmentResponseRepository'
)
 ...
 */
module.exports = class AssignmentResponseService {
  constructor ({ currentUser, language }) {
    this.repository = new AssignmentResponseRepository()
